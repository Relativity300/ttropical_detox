...
<body>
  ...
  <section>
    ...
    <div class="card carta" style="width: 18rem;">
      ...
      <div class="botones">
        ...
        <i class="bi bi-file-earmark-text icono"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
        ...
        <button type="button " class=" btn-primary button-boton" data-bs-toggle="modal" data-bs-target="#exampleModall">
          <i class="bi bi-file-earmark-text icono">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <h1>jugo mango.</h1>
                <form action="">
                  <label for="" margin: 1em>Cantidad </label><input class="cantidad" type="number" name=""
                    id=""><br><br>
        ...
        <div class="div-p">
          ...
          <!-- Button trigger modal -->
          <button type="button" class=" btn-primary button-boton-eliminar" data-bs-toggle="modal"
            data-bs-target="#eexampleModal">
            <i class="bi bi-cart-x icono"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
          ...
          <!-- Modal -->
          <div class="modal fade" id="eexampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
