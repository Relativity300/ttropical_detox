...
<body>
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="div-logo">
                        <a class="" href="dashboard.html">
                            <img src="IMG/Logo1.png" class="logonav" alt="homepage">
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
    ...
    <section class=" ">
        <div class="cdenter">
        <div class="pt-5">
            <h1 class="display-4 text-center ">Crear.</h1>
        </div>
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <div class="d-md-flex">
                <ol class="breadcrumb ms-auto">
                    <li>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@fat">Crear</button>
                    </li>
                </ol>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="exampleModalLabel">Crear jugos</h1>
                ...
                <div class="modal-body">
                  <form>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="message-text" type="number" name="" id="">
                      </div>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                                <h5 class="fw-bolder">Jugo verde</h5>
                                <!-- Product price-->
                                <!-- $40.00 - $80.00 -->
                            </div>
                        </div>
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                                <h5 class="fw-bolder">Jugo naturalez</h5>
                                <!-- Product price-->
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                                <h5 class="fw-bolder">Jugo Personalizado</h5>
                                <!-- Product price-->
                                $40.00
                            </div>
                        </div>
