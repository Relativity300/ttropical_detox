    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body modallll">
                ...
                <svg class="mas" xmlns="http://www.w3.org/2000/svg" width="100" height="50"
            ...
            <div class="div-botones">
                <button type="button" class="bbb btn btn-primary eliminarr"
                    data-bs-dismiss="modal">Eliminar.</button>
                <button type="button" class="bbb btn btn-primary" data-bs-dismiss="modal">Editar.</button>
            </div>
        </div>
    </div>
</div>  
            ...
            <div class="modal fade" id="elliminar" tabindex="-1" aria-labelledby="elliminar" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="titulo-Modal ">Editar: 1</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body modallll">
                            <form action="">
                            ...
                            <div class="cotenidoEdit">
                                <div class="editar">
                                    ...
                                    <ul>
                                        <li class="edi">Mango $2.000 <input class="cantidad" type="number" name=""
                                                id=""></li>
                                        <li class="edi">Mango $2.000 <input class="cantidad" type="number" name=""
                                                id=""></li>
                                        <li class="edi">Mango $2.000 <input class="cantidad" type="number" name=""
