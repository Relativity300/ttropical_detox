                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>1000569253</td>
                                            <td>Juan</td>
                                            <td>Ceballos Arboleda</td>
                                            <td>3015892266</td>
                                            <td>jpceballos@35@misena.edu.co</td>
                                            <td>Calle 65 #58 08</td>
                                            <td>Administrador</td>
                                            <td>
                                ...
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ventanaModal">Agregar Usuario</button>
