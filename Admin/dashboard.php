...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="table-responsive">
                    <table class="table no-wrap">
                        <thead>
                            <tr><th> <h1 class="titulo-ventas">ventas.</h1></th></tr>
                            <tr>
                                ...
                                <th class="border-top-0">Ociones</th>
                            ...
                            <tr>
                                ...
                                <td class="txt-oflo">
                                    ...
                                    <button type="button" class="button" data-bs-toggle="modal" data-bs-target="#elliminar">
                                        <i class="bi bi-trash"><svg xmlns="http://www.w3.org/2000/svg" width="50"
                                                height="50" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                                <path
            ...
            <!-- Modal1 -->
            <div class="modal fade" id="elliminar" tabindex="-1" aria-labelledby="elliminar"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="div-botones">
                            <button type="button" class="bbb btn btn-primary eliminarr" data-bs-dismiss="modal">Eliminar.</button>
                            <button type="button" class="bbb btn btn-primary" data-bs-dismiss="modal">cancelar.</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Modal2 -->
            <div class="modal fade" id="Datos" tabindex="-1" aria-labelledby="Datos"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="div-botones">
                            <button type="button" class="bbb btn btn-primary" data-bs-dismiss="modal">Atras.</button>
                        </div>
                    </div>
                </div>
            </div>
